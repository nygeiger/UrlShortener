                    ...
                    <td className="px-6 py-3">
                        <div className="flex flex-row gap-2">
                            <div className="cursor-pointer relative" onClick={() => copyToClipboard(item._id, item.shortUrl)}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`size-6 transition-all duration-500 hover:text-amber-700 ${copiedId === item._id && 'scale-125 text-green-400'}`}>
                            ...
                            <div className="cursor-pointer" onClick={() => handleDelete(item._id, item.ownerId)}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:text-amber-700">
